...
sudo wget https://api.downloads.anjuna.io/v1/releases/anjuna-nitro-runtime.1.36.0003.tar.gz --header="X-Anjuna-Auth-Token:{APIKEY}" -O "/home/ec2-user/anjuna-nitro-runtime.1.36.0003.tar.gz"
...
sudo wget "https://api.downloads.anjuna.io/v1/releases/license/nitro/license.yaml" --header="X-Anjuna-Auth-Token:{APIKEY}" -O "/opt/anjuna/license.yaml"
